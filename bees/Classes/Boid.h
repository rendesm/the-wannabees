...
@property(nonatomic) bool hasDisease;
@property(nonatomic) ccTime illnessTime;
@property(nonatomic) float damage;
@property(nonatomic) bool isCombatMode;
@property(nonatomic) float startMaxForce;
@property(nonatomic) float startMaxSpeed;
@property(nonatomic) CGRect scaledBoundingBox;
@property(nonatomic) int collisionType;
@property(nonatomic) CGPoint leftEdgePosition;
@property(nonatomic) int specy;
